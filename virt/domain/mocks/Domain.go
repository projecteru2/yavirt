...
import (
	...
	yavirtlibvirt "github.com/projecteru2/yavirt/pkg/libvirt"
)
...
// LibvirtDomain provides a mock function with given fields:
func (_m *Domain) LibvirtDomain() (yavirtlibvirt.Domain, error) {
	ret := _m.Called()

	var r0 yavirtlibvirt.Domain
	if rf, ok := ret.Get(0).(func() yavirtlibvirt.Domain); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(yavirtlibvirt.Domain)
		}
	}
