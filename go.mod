...
replace (
	...
	github.com/projectcalico/api => github.com/projectcalico/calico/api v0.0.0-20230510161715-15d193738928

	go.etcd.io/bbolt => github.com/coreos/bbolt v1.3.7
	...
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20230224204131-30e856af5c3e
